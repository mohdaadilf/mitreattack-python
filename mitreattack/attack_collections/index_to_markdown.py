...
class IndexToMarkdown:
    ...
    def index_to_markdown(indexobj):
        ...
        lines = [
            "<!-- begin index generated by mitreattack-python.navlayers.attack_collections.col_to_md.py -->",
            f"## {indexobj['name']}",
            f"\n{indexobj['description']}\n",
            f"### {indexobj['name']} Collections\n",
        ]

        for collection in indexobj["attack_collections"]:
        ...
        lines.append("<!-- end index generated by  mitreattack-python.navlayers.attack_collections.col_to_md.py -->")
