...
setuptools.setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "indexToMarkdown_cli=mitreattack.attack_collections.index_to_markdown:main",
            "collectionToIndex_cli=mitreattack.attack_collections.collection_to_index:main",
